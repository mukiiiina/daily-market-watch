...
| 功能 | 说明 | 触发方式 |
|------|------|----------|
| **早间盘前预热** | 昨日回顾 + 市场情绪 + 持仓盘前提示 + 今日看盘重点 | `report.py morning` / OpenClaw Cron |
| **盘中实时监控** | 主动查询大盘/个股/基金/板块的实时数据 | 自然语言指令或 CLI |
| **盘后总结** | 当日大盘总结 + 板块资金 + 市场情绪 + 持仓盈亏/成本盈亏 + 技术指标信号 + 明日预判 | `report.py evening` / OpenClaw Cron |
...
## 市场情绪
- 涨跌分布：涨 2567 / 跌 2851 / 平 168 | 涨停 66 | 跌停 2 | 等权涨幅 +0.23%
