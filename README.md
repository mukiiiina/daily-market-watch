...
- 新增 `fetch_market.py flow`，基于 akshare 分析 A 股主力/超大单/大单/中单/小单净流入
- 早盘/盘后报告的 `detailed` 模式，A 股持仓自动追加主力净流入提示
...
| **个股资金流向** | A 股主力/超大单/大单/中单/小单净流入分析 | `fetch_market.py flow` |
...
python scripts/fetch_market.py flow 000001
```
...
- ✅ **个股资金流向**：基于 akshare 分析 A 股主力/超大单/大单/中单/小单净流入，在报告中展示
